...
import com.android.modulcommons.utils.DVScreenUtil;
...
public class WebParentLayout extends FrameLayout {
	...
	public WebParentLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		...
		mWebViewprogressbar.setLayoutParams(new AbsoluteLayout.LayoutParams(AbsoluteLayout.LayoutParams.FILL_PARENT, DVScreenUtil.getInstance().dip2px(1), 0, 0));
