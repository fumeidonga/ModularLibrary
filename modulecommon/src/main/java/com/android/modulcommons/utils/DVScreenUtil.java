...
public class DVScreenUtil {

	private Context context;

	private DVScreenUtil() {}

	private DVScreenUtil(Context context) {
		this.context = context.getApplicationContext();
	}

	// 私有内部类，按需加载，用时加载，也就是延迟加载
	private static class Holder {
		private static DVScreenUtil singleton5 = new DVScreenUtil(DVApplicationUtil.getContext());
	}
	public static DVScreenUtil getInstance() {
